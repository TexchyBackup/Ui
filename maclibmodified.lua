	...
	function WindowFunctions:TabGroup()
		...
		function SectionFunctions:Tab(Settings)
			...
			function TabFunctions:Section(Settings)
				...
				function SectionFunctions:ToggleWithKeybind(Settings, Flag)
					local ToggleFunctions = { Settings = Settings, IgnoreConfig = false, Class = "ToggleWithKeybind" }
					local toggle = Instance.new("Frame")
					toggle.Name = "Toggle"
					toggle.AutomaticSize = Enum.AutomaticSize.Y
					toggle.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
					...
					keybindContainer.Position = UDim2.fromScale(0.70, 0.5)
					...
					local isBinding = false
					local reset = false
					local binded = ToggleFunctions.Settings.Default
					...
					function ToggleFunctions:Unbind()
						binded = nil
						binderBox.Text = ""
					end
